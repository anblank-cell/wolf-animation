      ...
      <main>
        ...
        <section id="section-4">
          <div className="bottom">
            <div className="left"></div>
            <div className="right">
              <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Laborum consectetur corrupti commodi nihil fuga consequuntur eaque, inventore natus, pariatur ratione id est tenetur in hic quas veniam! Laborum minus sapiente quod sed aperiam, voluptate exercitationem dolore quidem aspernatur soluta illum temporibus. Dolorum ratione qui, sint voluptas molestias delectus. Ullam, inventore?</p>
              <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Laborum consectetur corrupti commodi nihil fuga consequuntur eaque, inventore natus, pariatur ratione id est tenetur in hic quas veniam! Laborum minus sapiente quod sed aperiam, voluptate exercitationem dolore quidem aspernatur soluta illum temporibus. Dolorum ratione qui, sint voluptas molestias delectus. Ullam, inventore?</p>
            </div>
          </div>
        </section>
